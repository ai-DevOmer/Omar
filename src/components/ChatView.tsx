...
function HistoryDropdown({ onNewChat, onLoad, disabled }: HistoryDropdownProps) {
  ...
  return (
    <div ref={dropdownRef} className="relative">
      ...
      >
        <span className="text-[13px] font-semibold tracking-tight">omar-ai</span>
            ...
            <div className={messages.length === 0 && !streamingText && !streamingThinking ? "h-full" : "space-y-2"}>
              <AnimatePresence mode="popLayout">
                {messages.length === 0 && !streamingText && !streamingThinking ? (
                  ...
                  >
                    <img src="/omar-ai-bg.png" alt="OMAR AI Background" className={`${gifSize} h-auto opacity-30 rounded-2xl shadow-2xl`} />
                    <p className="text-sm mt-4 text-white/40 font-light tracking-wide">Welcome to OMAR AI. I'm here to assist you with peace and intelligence.</p>
<p className="text-[10px] mt-2 text-white/20 italic font-light">"Justice and peace for all. Stand with Palestine."</p>
                  </motion.div>
                ) : (
                  <>
            ...
            {isRunning ? (
              ...
              <div className="glass-card flex items-center gap-2 p-2">
                ...
                <textarea
                  ...
                  placeholder="كيف يمكن لـ OMAR AI مساعدتك اليوم؟"
                  rows={1}
