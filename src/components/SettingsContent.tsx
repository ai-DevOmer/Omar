...
export default function SettingsContent() {
  ...
  const shortcuts = [
    { keys: "⌘⇧␣", label: "البحث السريع (Spotlight)" },
    { keys: "⌘⇧H", label: "لقطة شاشة وسؤال" },
    { keys: "⌘⇧V", label: "تحدث للإرسال" },
    { keys: "⌃⇧C", label: "صوت ← وضع الكمبيوتر" },
    { keys: "⌃⇧B", label: "صوت ← وضع المتصفح" },
    { keys: "⌘⇧S", label: "إيقاف OMAR AI" },
    { keys: "⌘⇧Q", label: "إغلاق" },
  ];
