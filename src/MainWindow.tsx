...
export default function MainWindow() {
  ...
  if (state.mode === "idle") {
    return (
      ...
      >
        <img src="/omar-ai-logo.png" className="w-4 h-4" alt="OMAR AI Logo" />
        <span className="text-xs text-white/60 flex-1">استدعاء OMAR AI</span>
  ...
  if (state.mode === "spotlight") {
    ...
    return (
      ...
      >
        <img src="/omar-ai-logo.png" className="w-5 h-5 mr-3" alt="OMAR AI Logo" />
        <input
          type="text"
          autoFocus
          ...
          placeholder="ما الذي تود مني فعله؟"
    ...
    return (
      ...
      >
        ...
        >
          <div className="flex items-center gap-2">
            <img src="/omar-ai-logo.png" className="w-4 h-4" alt="OMAR AI Logo" />
            <span className="text-[11px] text-white/50 font-medium uppercase tracking-wider">OMAR AI</span>
          </div>
              ...
              >
                {isRunning ? (
                  <>
                    ...
                    />
                    <span className="text-white/30 text-xs">جاري العمل بذكاء...</span>
                  </>
                ) : (
