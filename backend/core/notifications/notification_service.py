...
KORTIX_HELLO_EMAIL = 'hello@omar-ai.com'
...
class NotificationService:
    ...
    async def send_task_completion_notification(
        ...
        try:
            ...
            task_url = f"https://www.omar-ai.com/projects/{project_id}/thread/{thread_id}" if project_id else f"https://www.omar-ai.com/thread/{thread_id}"
