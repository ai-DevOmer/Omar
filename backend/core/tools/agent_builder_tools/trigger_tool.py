        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "model": {
                        "type": "string",
                        "description": "Model to use for the scheduled execution. Options: 'omar-ai/basic' (default, free tier) or 'omar-ai/power' (requires paid subscription). If not specified, defaults to 'omar-ai/basic'."
                    }
                },
        ...
        try:
            ...
            for trigger in schedule_triggers:
                formatted = {
                    ...
                    "model": trigger.config.get("model", "omar-ai/basic"),
                    "is_active": trigger.is_active
                }
        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "model": {"type": "string", "description": "Model to use for the event execution. Options: 'omar-ai/basic' (default, free tier) or 'omar-ai/power' (requires paid subscription). If not specified, defaults to 'omar-ai/basic'."}
                },
