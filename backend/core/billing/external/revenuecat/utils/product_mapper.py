...
class ProductMapper:
    PRODUCT_MAPPING = {
        'omar-ai_plus_monthly': 'tier_2_20',
        'omar-ai_plus_yearly': 'tier_2_20',
        'plus:plus-monthly' : 'tier_2_20',
        'plus:plus-monthly' : 'tier_2_20',

        'omar-ai_pro_monthly': 'tier_6_50',
        'omar-ai_pro_yearly': 'tier_6_50',
        'pro:pro-monthly' : 'tier_6_50',
        'pro:pro-monthly' : 'tier_6_50',
        
        'omar-ai_ultra_monthly': 'tier_25_200',
        'omar-ai_ultra_yearly': 'tier_25_200',
