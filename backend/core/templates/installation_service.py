...
class InstallationService:
    ...
    async def _create_agent(
        ...
        if template.is_omar-ai_team:
            metadata['is_omar-ai_team'] = True
            metadata['omar-ai_template_id'] = template.template_id
        ...
        logger.debug(f"Created agent {agent_id} from template {template.template_id}, is_omar-ai_team: {template.is_omar-ai_team}")
        return agent_id
