    ...
    def _generate_text_response(
        ...
        if not tool_calls:
            ...
            if len(prompt) < 10:
                ...
                return "I'm OMAR AI, an AI assistant that can help you with various tasks including file operations, running commands, and searching the web."
            else:
