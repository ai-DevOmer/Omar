# OMAR AI Agent Evaluations

Evaluate OMAR AI agent performance using **Braintrust** with JSON-based test cases.
...
Results are automatically uploaded to: https://www.braintrust.dev/app/OMAR AI/p/OMAR AI%20Agent/experiments/
...
| `EVAL_MODEL` | Override model for evals (default: `omar-ai/basic`) |
