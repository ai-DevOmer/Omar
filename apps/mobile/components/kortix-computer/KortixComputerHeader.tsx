...
interface OMAR AIComputerHeaderProps {
...
/**
 * Shared header component for all OMAR AI Computer views (Files, File Viewer, Browser).
 ...
 */
export function OMAR AIComputerHeader({
  icon: IconComponent,
  onIconClick,
  iconTitle,
  title,
