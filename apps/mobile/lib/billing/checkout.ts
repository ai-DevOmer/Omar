 ...
 * 
 * Note: The backend should return omar-ai.com URLs that wrap/proxy Stripe,
...
// checkout URLs (should be omar-ai.com masked URLs, not direct stripe.com)
// ============================================================================
 ...
 * a omar-ai.com masked URL (not direct stripe.com for compliance)
 */
...
export async function openBillingPortal(returnUrl?: string): Promise<void> {
  ...
  try {
    ...
    const webBillingUrl = process.env.EXPO_PUBLIC_WEB_APP_URL 
      ...
      : 'https://www.omar-ai.com/subscription';
