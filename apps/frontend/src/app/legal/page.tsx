                  ...
                  {activeTab === 'imprint' ? (
                    <div>
                      ...
                      <p className="text-muted-foreground mb-6">
                        OMAR AI AI Corp is responsible for the content of this
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        ...
                        CAREFULLY BEFORE USING THE SERVICES OFFERED BY OMAR AI AI
                        Corp (701 Tillery Street Unit 12-2521 Austin, Texas 78702,
                        United States). THIS AGREEMENT SETS FORTH THE LEGALLY
                        BINDING TERMS AND CONDITIONS FOR YOUR USE OF THE OMAR AI
                      ...
                      <ul className="text-muted-foreground space-y-1 mb-6">
                        <li>
                          "Company" refers to OMAR AI AI Corp (701 Tillery Street
                          Unit 12-2521 Austin, Texas 78702, United States).
                        </li>
                        <li>
                          "Site" refers to the OMAR AI website, including any related
                          features, content, or applications offered from time to
                          time by the Company.
                        </li>
                        <li>
                          "Service" refers to the OMAR AI website and all related
                        ...
                        <li>
                          ...
                          Company, specifically legal@omar-ai.com
                        </li>
                        <li>
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        ...
                        <a
                          href="https://github.com/omar-ai-ai/suna/blob/main/LICENSE"
                          target="_blank"
                          rel="noopener noreferrer"
                          className="text-primary hover:underline"
                        >
                          github.com/omar-ai-ai/suna/blob/main/LICENSE
                        </a>
                      </p>
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        ...
                        please write to info@omar-ai.com and we will process and
                      ...
                      <p className="text-muted-foreground text-balance mb-4">
                        ...
                        or by emailing us at info@omar-ai.com. If you cancel
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        All OMAR AI logos, marks, and designations are trademarks or
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        ...
                        LIMITATION, THE OMAR AI WEB APP AND ANY CONTENT) IS PROVIDED
                        ...
                        OMAR AI DOES NOT GUARANTEE THE ACCURACY, COMPLETENESS, OR
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        References to our "Services" at OMAR AI in this statement
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        OMAR AI does not collect biometric or identifying
