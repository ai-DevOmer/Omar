...
export const metadata: Metadata = {
  title: 'Suna is now OMAR AI | OMAR AI Suna - Open Source AI Worker',
  description: 'Suna has rebranded to OMAR AI. OMAR AI (formerly Suna) is the same powerful open source AI assistant and generalist AI worker you know and love, now with a new name and bigger vision.',
  keywords: [
    'Suna',
    'OMAR AI Suna',
    'Suna AI',
  ...
  openGraph: {
    title: 'Suna is now OMAR AI',
    description: 'OMAR AI (formerly Suna) - Same powerful open source AI worker, new name.',
    type: 'website',
    url: 'https://www.omar-ai.com/suna',
    siteName: 'OMAR AI',
    images: [
      {
        url: '/banner.png',
  ...
  alternates: {
    canonical: 'https://www.omar-ai.com/suna',
  },
  robots: {
    index: true,
    follow: true,
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'Organization',
            name: 'OMAR AI',
            alternateName: ['Suna', 'OMAR AI Suna', 'Suna AI'],
            url: 'https://www.omar-ai.com',
            logo: 'https://www.omar-ai.com/favicon.png',
            sameAs: [
              'https://github.com/omar-ai-ai',
              'https://x.com/omar-ai',
              'https://linkedin.com/company/omar-ai',
            ],
            description:
              'OMAR AI (formerly known as Suna) is an open source generalist AI worker that helps you accomplish real-world tasks through natural conversation.',
          }),
        }}
      />
            ...
            itemListElement: [
              {
                ...
                position: 1,
                name: 'Home',
                item: 'https://www.omar-ai.com',
              },
              {
                '@type': 'ListItem',
                position: 2,
                name: 'Suna is now OMAR AI',
                item: 'https://www.omar-ai.com/suna',
              },
            ],
          }),
        }}
        ...
        <div className="relative flex flex-col items-center w-full px-4 sm:px-6">
          ...
          <div className="relative z-10 pt-16 sm:pt-24 md:pt-32 mx-auto h-full w-full max-w-6xl flex flex-col items-center justify-center">
            <div className="flex flex-col items-center justify-center gap-3 sm:gap-4 pt-8 sm:pt-20 max-w-4xl mx-auto pb-10">
              {/* OMAR AI Symbol with grain texture */}
              <div className="relative mb-8 sm:mb-12" style={{ width: '80px', height: '80px' }}>
                ...
                <div
                  ...
                  style={{
                    ...
                    opacity: 0.6,
                    maskImage: 'url(/omar-ai-symbol.svg)',
                    WebkitMaskImage: 'url(/omar-ai-symbol.svg)',
                    maskSize: 'contain',
            ...
            <div className="space-y-20 sm:space-y-32 text-center">
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-3 text-base md:text-lg text-muted-foreground font-medium">
                  <p>Our name changed from Suna to OMAR AI</p>
                  <p>Our domain is now omar-ai.com</p>
                </div>
              </div>
              ...
              <div className="space-y-6">
                ...
                <p className="text-base md:text-lg text-muted-foreground font-medium">
                  Our GitHub repository remains at github.com/omar-ai-ai/suna
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="relative z-10 text-center max-w-2xl mx-auto pb-20 pt-12 border-t border-border/50">
            <p className="text-sm text-muted-foreground/60 leading-relaxed font-medium">
              Looking for Suna? You've found us. OMAR AI is the evolution of Suna — the same open
              ...
              Suna", or "OMAR AI Suna" — this is the official continuation of the Suna project under
              the OMAR AI brand.
            </p>
          </div>
        </div>
