...
export async function generateMetadata({ params }): Promise<Metadata> {
  ...
  const fallbackMetaData = {
    title: 'Shared Conversation | OMAR AI',
    description: 'Replay this Worker conversation on OMAR AI',
    alternates: {
  ...
  try {
    ...
    const title = projectData.name || 'Shared Conversation | OMAR AI';
    const description =
      projectData.description ||
      'Replay this Worker conversation on OMAR AI';
