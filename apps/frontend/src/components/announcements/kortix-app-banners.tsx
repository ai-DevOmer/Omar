...
const MOBILE_STORAGE_KEY = 'omar-ai-mobile-banner-dismissed';
const DESKTOP_STORAGE_KEY = 'omar-ai-desktop-banner-dismissed';

const STORE_LINKS = {
  ios: 'https://apps.apple.com/ie/app/omar-ai/id6754448524',
  android: 'https://play.google.com/store/apps/details?id=com.omar-ai.app',
};

const DOWNLOAD_LINKS = {
  windows: 'https://download.omar-ai.com/desktop/latest/windows/OMAR AI%20Setup%201.0.0.exe',
  macArm: 'https://download.omar-ai.com/desktop/latest/macos/OMAR AI-1.0.0-arm64.dmg',
  macIntel: 'https://download.omar-ai.com/desktop/latest/macos/OMAR AI-1.0.0-x64.dmg',
};

type MobilePlatform = 'ios' | 'android';
type DesktopPlatform = 'windows' | 'mac';

type OMAR AIAppBannersProps = {
  /**
...
export function OMAR AIAppBanners(props: OMAR AIAppBannersProps) {
  ...
  useEffect(() => {
    ...
    if (process.env.NODE_ENV !== 'production') {
      console.log('[OMAR AIAppBanners] flags', { disableMobileAdvertising });
    }
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div className="w-10 h-10 rounded-xl bg-foreground dark:bg-white flex items-center justify-center shadow-sm">
                  <OMAR AILogo size={20} className="invert dark:invert-0" />
                </div>
              </div>
            </motion.div>
          ) : (isExpanded || !showBothBanners) ? (
            ...
            >
              ...
              {mobileVisible && (
                ...
                <img 
                  ...
                  alt={`QR Code to download OMAR AI on ${selectedMobilePlatform === 'ios' ? 'App Store' : 'Play Store'}`}
                  width={100}
                  height={100}
                  className="block"
                />
                {/* OMAR AI logo in center */}
              ...
              {desktopVisible && (
                ...
                >
                  <div className="relative bg-white dark:bg-[#2a2a2a] rounded-xl shadow-xl overflow-hidden border border-border/60 dark:border-[#232324]">
                    ...
                    <div className="relative h-[80px] bg-muted dark:bg-[#e8e4df] flex items-center justify-center">
                      <div className="w-[160px] h-[50px] bg-background dark:bg-white rounded-lg p-2 relative flex items-center justify-center border border-border/40 dark:border-transparent">
                        ...
                        <div className="w-8 h-8 bg-foreground dark:bg-[#1a1a1a] rounded-lg flex items-center justify-center">
                          <OMAR AILogo size={16} className="invert dark:invert" />
                        </div>
                    ...
                    <div className="p-4 bg-muted/50 dark:bg-[#161618]">
                      <h3 className="text-foreground dark:text-white text-sm font-semibold mb-1">
                        OMAR AI for Desktop is here
                      </h3>
                      <p className="text-muted-foreground dark:text-white/60 text-xs leading-relaxed mb-3">
                        Hand it off to OMAR AI. From anywhere on your {desktopPlatform === 'mac' ? 'Mac' : 'Desktop'}. Download now.
                      </p>
