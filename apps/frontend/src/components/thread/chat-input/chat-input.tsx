...
// OMAR AI agent modes switcher - isolated from typing state
        ...
        <TooltipTrigger asChild>
          ...
          >
            {((loading || isUploading) && !isAgentRunning) ? (
              <OMAR AILoader size="small" customSize={20} variant={buttonLoaderVariant} />
            ) : showAddToQueue ? (
...
export const ChatInput = memo(forwardRef<ChatInputHandles, ChatInputProps>(
  (
    ...
    const [isModeDismissing, setIsModeDismissing] = useState(false);    // OMAR AI Agent Modes feature flag
    ...
    // Check if selected agent is OMAR AI based on agent data
    // While loading, default to OMAR AI (assume OMAR AI is the default agent)
